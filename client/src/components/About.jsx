      ...
      <div className="container">
        ...
        <div className="row">
          <div className="col-md-4">
            <ul className="info">
              <li><span className="first-block">Full Name:</span><span className="second-block">Ali Ahammad</span></li>
              <li><span className="first-block">Phone:</span><span className="second-block">+91 9895850894</span></li>
              <li><span className="first-block">Email:</span><span className="second-block">mail@aliahammad.com</span></li>
              <li><span className="first-block">Website:</span><span className="second-block">www.aliahammad.com</span></li>
              <li><span className="first-block">Address:</span><span className="second-block">House No : 254,<br/>12 Muri Nagar, Thattamala PO, Kollam 691020, Kerala, India.</span></li>
            </ul>
          </div>
